...
| Quotation  | Candles (OHLCV)                   | Time unit OHLCV stats per pair                           | Partial      | ✖️           | REST: 1-minute candles via `/v1/candles/minutes/1` and Seconds candles via `/v1/candles/seconds`. Other intervals and day/week/month/year are missing. |
